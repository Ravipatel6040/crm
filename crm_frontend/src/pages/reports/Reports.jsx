...
import { Card, Badge, Table, Tr, Td, EmptyState } from "../../components/common";
...
export default function Reports() {
  // RTK Query live data — no mock fallback. An empty result means an empty
  // state, not fabricated numbers standing in for real ones.
      ...
      <Card padding="p-0" className="mb-6">
        <div className="p-5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="h-64">
              {sourceData.length === 0 ? (
                <EmptyState title="No lead source data yet" description="Add leads to see the channel breakdown." />
              ) : (
            ...
            {campaigns.length === 0 ? (
              <EmptyState title="No campaigns yet" description="Create a campaign to see it here." />
            ) : (
