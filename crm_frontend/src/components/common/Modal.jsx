    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div
        className={classNames(
          "relative w-full bg-white shadow-popover animate-slideUp",
      ...
      >
        <div className="flex items-start justify-between gap-4 px-5 sm:px-6 py-4 border-b border-slate-100 shrink-0">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition focus-ring"
          >
            <X size={18} />
          </button>
        </div>
